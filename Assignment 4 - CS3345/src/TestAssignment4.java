...
public class TestAssignment4 {
   public static void main(String[] args) {
	  ...
	  String filePath = "C:\\Users\\saumi\\Desktop\\myFiles\\education\\Programming\\Eclipse WorkSpace\\Assignment 4 - CS3345\\src\\Patient.txt";
	  ...
	  //writeFile(filePath, patientList);
	  ...
	  Date today = new Date();
      try {
         today = formatter.parse("04/01/2023");
	  ...
	  System.out.println("\nWhat would you like to do with the Patient Database today?\n\nTo just get a list of all the patients, type: \"directory\"\nTo add a new patient, type: \"add patient\""
	  		...
	  		+ "\nTo get all of annual patients, type: \"annual appointments\"\n");
	  ...
	  switch(input) {
	  	//inserts a new patient into the database
	  	 case "add patient":
		    System.out.print("\nEnter the new patient in the following format\n[lastName firstName,docName,appt1(MM/DD/YYYY),appt2,...  & capitalize the initial(s) of all names]: ");
	  	...
	  	//deletes a patient from the database
	  	 ...
	  	 case "edit patient":
	  	    ...
	  	    System.out.print("\nWould you like to add, change or delete an appointment? type: \"add\",\"change\", or \"delete\" --> ");
	  	    ...
	  	    switch(response) {
	  	    	...
	  	    	case "add":
	  	    		System.out.print("\nType in the date you would like to add in the following format [MM/DD/YYYY]: ");
	  	...
	  	//clear newPatient.txt file and print updated database to it
	  		clearFile(filePath);
		    writeFile(filePath, annualApptByDoc);
	  		break;
	  	//gives you a list of patients that have annual appointments
	  	 case "annual appointments":
	  		Patient[] annualAppt = new Patient[0];
	  		for(int i = 0; i < patientList.length; i++) {
	  			Date[] appts = patientList[i].getDateArray();
	  			if(appts.length == 2 && patientList[i].getDaysInBtwn(appts[0], appts[1]) >= 365) {
	  				annualAppt = addIntoArray(patientList[i], annualAppt);
	  			}
	  		}
	  	//clear newPatient.txt file and print updated database to it
	  		clearFile(filePath);
		    writeFile(filePath, annualAppt);
	  		break;
